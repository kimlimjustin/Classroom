        ...
        <div className = "container-fluid">
                        ...
                        <div>
                            {classwork.options && classwork.options.map(option => (
                                <div className="form-group" key = {option}>
                                    <input type = "checkbox" className="form-control" id={option} name="answer" value={option} 
                                    onChange = {({target: {checked, value}}) => {if(checked) setInputAnswer(prev => [...prev, value]); 
                                    else setInputAnswer(inputAnswer.filter(answer => answer !== value))}} />
            ...
            <div className = "classwork-modal" id = "answers">
                <div className="classwork-content container">
                    ...
                    {answers.map(answer => {
                        return <p key = {answer._id}>{answer.student.username} answered <b>{answer.answer.join(', ')}</b> {moment(answer.answeredOn).fromNow()}
